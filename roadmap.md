...
## Rules
- Only semantic tokens; no hardcoded colors.
- Never change `/app` crawler functionality or the report layout.
- Validate with Playwright after each step.

## Open items (carried over)
- [ ] Report PDF: `02 Category Health Scores` heading still orphans at page break in Chromium.
